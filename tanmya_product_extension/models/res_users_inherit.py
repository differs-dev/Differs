        ...
        if user:
            ...
            if products_type == 2:
                ...
                for product_preference in products_preferences:
                    ...
                    user_preference = {
                        'id': product_preference.id,
                        'image_128': product_preference.image_1920,
                        'image_1920': product_preference.image_1920,
                        'name': product_preference.name,
                        'list_price': product_preference.list_price,
                        'uom': product_preference.uom_id.name,
                        'preference_state': product_preference.status,
                        'calories': product_preference.calories,
                        'carbs': product_preference.carbs,
                        'protein': product_preference.protein,
                        'fat': product_preference.fat,
                        'fiber': product_preference.fiber,
                        'iron': product_preference.iron,
                        'description': product_preference.description,
                        'product_variants': self.get_products_variants_details(product_preference.product_id.id),
                        'additional_description': product_preference.mobile_description,
                        'composition': product_preference.x_studio_composition,
                        'conservation_et_utilisation': product_preference.x_studio_conservation_et_utilisation,
                        'product_more_info': product_preference.x_studio_product_more_info,
